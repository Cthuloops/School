# this program runs functions on list of dicts
# 03/09/2024
# CSC121 M4Poject Nested Dicts
# Harley Coughlin
...
def main():
    ...
    while (keep_going):
        ...
        if option == 1:
            m4_functions.display_registry_content(student_registry)
        elif option == 2:
            m4_functions.display_course_roster(student_registry)
        elif option == 3:
            m4_functions.list_by_major(student_registry)
        elif option == 4:
            m4_functions.search_by_id(student_registry)
        elif option == 5:
